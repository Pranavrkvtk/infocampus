...
export default function InstructorDashboard() {
  ...
  useEffect(() => {
    ...
    // No need to fetch for course-manager as it handles its own data
  }, [activeTab]);
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case "media":       
        return <MediaTab videoUrl={videoUrl} videoLoading={videoLoading} fetchHomeVideo={fetchHomeVideo} setVideoLoading={setVideoLoading} />;
  ...
  // ✅ ADD "Course Manager" to navigation items
  const navItems = [
    { icon: "📊", label: "Dashboard",      id: "dashboard"      },
    { icon: "🌐", label: "My Courses",     id: "courses"        },
    { icon: "👨‍🎓", label: "My Students",   id: "students"       },
    { icon: "🎬", label: "Media",          id: "media"          },
    { icon: "🏗️", label: "Course Manager", id: "course-manager" }, // ✅ Added this line
  ];
  ...
  const PAGE_TITLES = {
    ...
    "course-manager":"Course Manager", // ✅ Added this line
  };
  ...
  const PAGE_SUBS = {
    ...
    "course-manager":"Create and manage courses, topics, subtopics, notes, videos, and exam questions", // ✅ Added this line
  };
