...
const InterviewTab = ({ subtopicId, subtopic, onUpdate, toast, initialData }) => {
  ...
  const {
    ...
    subtopicId,
    toast,
    endpoint: `/admin/subtopics/${subtopicId}/upload-interview-pdf`,
    ...
    <>
      <div style={{ padding: 22 }}>
        <div style={{ 
          ...
          <Lbl>🎤 Interview Content (Admin Editable)</Lbl>
          <div style={{ display: 'flex', gap: 8 }}>
            <Btn 
              size="sm" 
              onClick={clearInterviewContent} 
              disabled={saving || !interviewContent} 
              variant="danger"
            >
        ...
        <DocumentUploadButton
          ...
          buttonId={`interview-upload-${subtopicId}`}
        />
